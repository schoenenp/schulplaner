...
import { fileToBase64 } from "@/server/util/pdf/functions";
...
export default function PreviewImage(props: { file?: string | File }) {
  ...
  return (
    <div className="relative aspect-square size-full overflow-hidden p-4">
      <Image className="object-cover p-4" src={previewUrl} fill alt="preview" />
    </div>
  );
}
